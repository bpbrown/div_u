...
xavg = lambda A: d3.integ(A,'x')/Lx

tau_div = tau_c1 + lift(tau_c2, -1)
tau_b = lift(tau_b1, -1) + lift(tau_b2, -2)
tau_u = lift(tau_u1, -1) + lift(tau_u2, -2) + lift(tau_u3, -3)
...
problem.add_equation("ez@tau_u3 = 0")
problem.add_equation("ex@tau_u1 + tau_c3 = 0")
problem.add_equation("integ(ex@tau_u3) = 0")
...
scalars.add_task(np.abs(tau_c1), name='tau_c1')
scalars.add_task(np.abs(tau_c2), name='tau_c2')
scalars.add_task(xavg(np.abs(tau_b1)), name='tau_b1')
scalars.add_task(xavg(np.abs(tau_b2)), name='tau_b2')
scalars.add_task(xavg(np.sqrt(tau_u1@tau_u1)), name='tau_u1')
scalars.add_task(xavg(np.sqrt(tau_u2@tau_u2)), name='tau_u2')
scalars.add_task(xavg(np.sqrt(tau_u3@tau_u3)), name='tau_u3')
scalars.add_task(np.sqrt(volavg(tau_div**2)), name='tau_div')
